const { CucumberExpression, RegularExpression } = require('cucumber/node_modules/cucumber-expressions');
const parameterTypeRegistry = require('cucumber/lib/support_code_library_builder').default.options.parameterTypeRegistry;
...
module.exports = {
  defineHelper(pattern, callback) {
    ...
    let expression = new Expression(pattern, parameterTypeRegistry);
